<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChildDeviceList.aspx.cs" Inherits="Web.Child.ChildDeviceList" %>
        ...
        function setImage(docObj) {
            ...
            if (docObj.files && docObj.files[0]) {
                ...
                reader.onload = function (evt) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '/API/WebService.asmx/Images',
                ...
                success: function (data) {
                    if (data == "null") {
                        ...
                        $.each(JSON.parse(data), function (i, e) {
                            ...
                            if (i % 2 != 0) {
                                $("#devices").append('<div class="itemright">' +
                                                        '<img src="' + e.qrticket + '" width="85%" onclick="getPicture(this)" height="383"/>' +
                        ...
                        $("[name=qh]").click(function () {
                            ...
                            $.ajax({
                                url: '/API/WebService.asmx/QHDevices',
                                type: 'get',
                        ...
                        $("[name=del]").click(function () {
                            ...
                            $("#qr").click(function () {
                                $.ajax({
                                    url: '/API/WebService.asmx/DelDevice?deviceId=' + deviceId,
                                    type: 'get',
                                    success: function (data) {
                                        if (data == "true") {
