<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChildList.aspx.cs" Inherits="Web.Child.ChildList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="listen">
            <asp:Repeater ID="Rep_lit" runat="server">
                <ItemTemplate>
                    <dl style="border: 0px solid red;">
                        <dt>
                            ...
                            <%--<a href="ChildList.aspx?id=<%#Eval("Id") %>" val="<%#Eval("Id") %>">
                                <img src="<%#Eval("Cover") %>"
                                    width="93%" />
                            </a>--%>
                        </dt>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#listen a").click(function () {
            ...
            //三级页面直接进入页面
            window.location.href = "ChildVidelList.aspx?q=" + id;
        });
    });
</script>
</html>
